                    ...
                    <div class="buttons">
                        ...
                        <ul class="uls">
                            <li class="px-3">
                                ...
                                <a class=" a btn-info text-white rounded link px-3 py-2 me-3" href="formpayment.php">ADD payment</a>                                 
                            </li>
                        </ul>
                    </div>
                                ...
                                <?php
                                    ...
                                    if($res->num_rows > 0){
                                        while($key = $res->fetch_assoc()){{
                                            ...
                                            echo'<td>'.$key['amountpaid'].'.00 DHS</td>';
                                            echo'<td>'.$key['balanceamount'].'.00 DHS</td>';
                                            echo'<td>'.$key['dateofadmission'].'</td>';
                                            echo '
                                            <td>
                                            <a href="./infopayment.php?id='.$key['id'].'">
