...
<body>
    <main>
        <?php
             ...
             include 'navbar.php';
             ?>
             <a class=" a btn-info text-white rounded link px-3 py-2 me-3" href="formaddcourse.php">ADD Course</a>
             ...
             if($res->num_rows > 0){
                 while($key = $res->fetch_assoc()){{
                    ...
                    echo '<td>
                    <a href="./editcourse.php?id='.$key['id'].'">
                    ...
                    <a href="./deletecourse.php?id='.$key['id'].'">
